            ...
            <form method="post" action="{{ route('vales.store') }}">
                <div class="form-row">
                    ...
                    <div class="col" style="display: none;">
                        ...
                        <input type="text" class="form-control" name="form_status" id="form_status"
                               placeholder="Form Status" value="Pending"/>
                    </div>
                    <div class="col">
                        <label for="receipt_number">Receipt Number:</label>
                        <input type="text" class="form-control" name="receipt_number" id="receipt_number"
                               placeholder="Receipt Number" value="To be Updated" readonly/>
                    </div>
                    <div class="col">
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="vehicle_description" id="vehicle_description"
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="quantity" id="quantity"
                               placeholder="Input Quantity" value="0"/>
                    </div>
                    <div class="col">
                        <label for="unit_cost">Unit Cost:</label>
                        <input type="number" class="form-control" name="unit_cost" id="unit_cost"
                               placeholder="Input Unit Cost" value="0" readonly/>
                    </div>
                </div>
                <br>
                <div class="form-row">
                    <div class="col">
                        ...
                        <input type="number" class="form-control" name="total_amount" id="total_amount"
                               placeholder="Input Total Amount" value="0" readonly/>
                    </div>
